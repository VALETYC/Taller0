...
public class ConsolaOlimpicos
{
		...
		while (continuar)
		{
			try
			{
				...
				if (opcion_seleccionada == 1)
					...
					ejecutarConsultarRepresentacion();
	...
	private void ejecutarConsultarRepresentacion()
	{
		String atleta = input("Por favor ingrese el nombre de un atleta");
		Pais pais = calculadora.PaisRepresentante(atleta);
		if (pais == null)
		{
			System.out.println("No existe un atleta con ese nombre");
		}
		else {
			System.out.println("El atleta " + atleta + " representa el pais " + pais.darNombre() + ".");
